...
import '../../main.dart';
import '../../model/my_follower_model.dart';
import '../../theme/theme.dart';
import '../../view_model/my_followers_view_model.dart';
...
class _FollowerScreenState extends State<FollowerScreen> {
  ...
  final follower=  Provider.of<MyFollowersViewModel>(context,listen: false).myFollowersList.data?.data;
    return   Column(
      children: [
        Padding(
        ...
        follower!=null&&follower.length!=0?    Expanded(
          child: ListView.builder(
            itemCount: follower?.length??0,
            itemBuilder: (context, index) {
              return _buildUserTile(follower?[index]);
            },
          ),
  ...
  Widget _buildUserTile(Data? follower) {
    return ListTile(
      ...
      trailing: follower?.isFollowedByCurrentUser??""
          ? Container(
        width: widths * 0.25,
