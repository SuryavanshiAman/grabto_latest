class RecomendedModel {
  ...
  RecomendedModel({this.res, this.data});
  ...
  RecomendedModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(new RecommendedData.fromJson(v));
      });
    }
  }
  ...
  RecommendedData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['image'] != null) {
      ...
      json['image'].forEach((v) {
        image!.add(new RecommendedImage.fromJson(v));
      });
    }
  }
...
class RecommendedImage {
  ...
  RecommendedImage({this.url});

  RecommendedImage.fromJson(Map<String, dynamic> json) {
    url = json['url'];
  }
